...
# 路径设置
RESULTS_DIR = "/Users/qianshen/torch_hd/torch_hd/qs_hdc/multi_model/mm_mnist/results"
OUTPUT_FILE = os.path.join(RESULTS_DIR, f"nonbinary_mnist_results_{datetime.now().strftime('%Y%m%d_%H%M%S')}.csv")
