...
RESULTS_DIR = "/Users/qianshen/torch_hd/torch_hd/qs_hdc/multi_model/mm_ucihar/results"
OUTPUT_FILE = os.path.join(RESULTS_DIR, f"nonbinary_ucihar_results_{datetime.now().strftime('%Y%m%d_%H%M%S')}.csv")

# 确保目录存在
os.makedirs(RESULTS_DIR, exist_ok=True)

# Load UCIHAR dataset
# Assuming data is in ../data relative to the script or common data dir
# Using absolute path for safety as seen in other scripts or just ../data
...
class Classifier(nn.Module):
    ...
    def encode(self, x: Tensor) -> Tensor:
        # UCIHAR input is already features
