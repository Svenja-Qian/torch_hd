...
# 路径设置
RESULTS_DIR = "/Users/qianshen/torch_hd/torch_hd/qs_hdc/multi_model/mm_emg/results"
OUTPUT_FILE = os.path.join(RESULTS_DIR, f"nonbinary_emg_results_{datetime.now().strftime('%Y%m%d_%H%M%S')}.csv")

# 确保目录存在
os.makedirs(RESULTS_DIR, exist_ok=True)

# Load EMGHandGestures using absolute path
# Using common data directory
...
class Classifier(nn.Module):
    ...
    def encode(self, x: Tensor) -> Tensor:
        # Input is already flattened by dataset transform
