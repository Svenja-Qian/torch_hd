...
module tb_hdc_ensemble_top;
    ...
    // -------------------------------------------------------------------------
    // DUT parameters (MNIST-aligned configuration)
    // -------------------------------------------------------------------------
    localparam int unsigned HV_DIM          = 2048;
    localparam int unsigned NUM_EXPERTS     = 3;
    localparam int unsigned NUM_CLASSES     = 10;
    localparam int unsigned CHUNK_WIDTH     = 32;
    localparam int unsigned FEAT_WIDTH      = 16;
    localparam int unsigned MAX_FEATURES    = 196;  // 78 shared + 118 private rows / expert
    ...
    localparam string PROJ_FILE_0           = "generated/mnist_hw_init/proj0.mem";
    localparam string PROJ_FILE_1           = "generated/mnist_hw_init/proj1.mem";
    localparam string PROJ_FILE_2           = "generated/mnist_hw_init/proj2.mem";
    localparam string CENT_FILE_0           = "generated/mnist_hw_init/centroid0.mem";
    localparam string CENT_FILE_1           = "generated/mnist_hw_init/centroid1.mem";
    localparam string CENT_FILE_2           = "generated/mnist_hw_init/centroid2.mem";
    localparam string BOOST_FILE            = "generated/mnist_hw_init/boost_weights.mem";

    // MNIST feature-importance split:
    // 784 total pixels -> 78 shared + 118 private features per expert.
    localparam int unsigned N_SHARED        = 78;
    localparam int unsigned N_PRIV_0        = 118;
    localparam int unsigned N_PRIV_1        = 118;
    localparam int unsigned N_PRIV_2        = 118;
    ...
    task automatic init_test_features;
        ...
        // exported projection BRAMs, not raw MNIST pixel indices.
