...
def compute_importances(X, y, feature_names=None, test_size=0.2, random_state=42, n_estimators=400, max_depth=None, max_features="sqrt", n_jobs=-1):
    ...
    perm = permutation_importance(rf, X_test, y_test, n_repeats=10, random_state=random_state, n_jobs=n_jobs)
...
def main():
    ...
    parser.add_argument("--dataset", type=str, default="all", choices=["isolet", "mnist", "har", "all"])
