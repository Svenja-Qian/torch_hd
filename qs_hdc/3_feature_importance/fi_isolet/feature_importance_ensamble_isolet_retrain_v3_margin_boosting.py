...
def main():
    ...
    # Path is relative to this script: ../../rf_feature_importance_results/isolet_feature_importance.csv
    importance_csv_path = os.path.normpath(
        os.path.join(parent_dir, "rf_feature_importance_results/isolet_feature_importance.csv")
    )
    ...
    filename = f"isolet_fi_D{args.D_total}_E{args.E}_{args.weighting}_rr{int(args.per_expert_ratio * 100)}"
    if args.margin > 0:
