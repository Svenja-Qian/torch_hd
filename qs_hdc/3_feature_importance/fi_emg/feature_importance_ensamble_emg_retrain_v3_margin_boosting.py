...
def run_experiment(
    ...
    dataset = EMGHandGestures(data_dir, download=True)
    ...
    for r in range(num_runs):
        ...
        # EMG specific: Split dataset into Train/Test (20% test)
...
def main():
    ...
    filename = f"emg_fi_D{args.D_total}_E{args.E}_{args.weighting}_rr{int(args.per_expert_ratio * 100)}"
    if args.margin > 0:
